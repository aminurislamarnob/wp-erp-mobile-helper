<div id="erp-app-helper-leave-modal" class="erp-app-helper-modal">
    <div class="erp-app-helper-modal-content">
        <div class="erp-app-helper-modal-header">
            <h2><?php _e( 'Required Approval', 'wp-erp-app-helper' ); ?></h2>
        ...
        <div class="erp-app-helper-modal-body">
            ...
            <div class="erp-app-helper-form-group">
                <label for="erp-app-helper-approver-select"><?php _e( 'Select Approver', 'wp-erp-app-helper' ); ?></label>
                <select id="erp-app-helper-approver-select">
                    <!-- Options populated via AJAX -->
                </select>
                <p class="description"><?php _e( 'Only Team Leads and HR Managers are shown.', 'wp-erp-app-helper' ); ?></p>
            </div>
        </div>
        <div class="erp-app-helper-modal-footer">
            <button type="button" class="erp-app-helper-btn erp-app-helper-btn-secondary" id="erp-app-helper-modal-close"><?php _e( 'Cancel', 'wp-erp-app-helper' ); ?></button>
            <button type="button" class="erp-app-helper-btn erp-app-helper-btn-primary" id="erp-app-helper-modal-save"><?php _e( 'Save', 'wp-erp-app-helper' ); ?></button>
        </div>
    </div>
</div>
